...
void Menu::showMainMenu() const {
    ...
    std::cout << "4. Отримати перелік і загальне число усіх працівників за стажом роборти\n";
    ...
    std::cout << "7. Отримати перелік і загальне число усіх працівників за ознакою наявнісі дітей\n";
    ...
    std::cout << "45. Отримати перелік і загальне число пасажирів за ознакою здачі речей в багажне відділення\n";
